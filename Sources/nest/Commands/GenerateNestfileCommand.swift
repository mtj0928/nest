...
let templateString = """
amends "https://github.com/mtj0928/nest/releases/download/0.0.7/Nestfile.pkl"

artifacts = new Listing {
  // Example 1: Specify Repository
  new Repository {
    reference = "mtj0928/nest" // or htpps://github.com/mtj0928/nest
    version = "0.0.8" // (Optional) If version doesn't exit, latest release is used.
  }
